...
------------ ANSWER -------------------
#1
A-The variable y is in the local scope within the function and can't be accessed outside the function.  Variable x is a global scope variable and can be accessed anywhere.  y would be undefined, and x would printe it's string.
...
/*************************************************************************************
------------ ANSWER -------------------
console.log (x) would not print anything because of function hoisting.

console.log(y) isn't mentioned anywhere?????
**************************************************************************************/
...
(function() {
  ...
  var accountCheck = function() {
    ...
    var greeting = return greeting();
    var accountStat = return accountStat();

    function returnGreeting(a, b){
      a + b
    }
  }
accountCheck();
